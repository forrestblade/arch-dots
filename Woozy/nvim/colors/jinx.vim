...
let s:jinx.red    = ['#c66f65', 210,  1]
let s:jinx.green  = ['#76a39e', 108,  2]
let s:jinx.yellow = ['#ffc97f', 220,  3]
let s:jinx.blue   = ['#0068ab',  32,  4]
let s:jinx.purple = ['#c6446b', 140,  5]
let s:jinx.cyan   = ['#6bb9df',  81,  6]
